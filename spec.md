...
| **v2.2** | 18/9 09:30 | Triển khai khối R6 (Validation 5 người dùng ngoài nhóm): Khắc phục điểm nghẽn thị giác người dùng bằng cách in đậm các mốc giờ deadline vàng (`23:59`, `12:00 trưa`), tăng cỡ chữ trích dẫn quy chế, bổ sung tooltip cho nút `TA-Bridge` và nhúng email `AIthucchien@vinuni.edu.vn` vào văn bản khẩn cấp. | Phản hồi từ 5 người dùng tại `validation/user_testing_log.md` (chuẩn Mom Test cho CP5). |